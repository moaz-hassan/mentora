    ...
    <div className="bg-white dark:bg-neutral-900 rounded-lg shadow-sm border border-gray-200 dark:border-neutral-800 p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Link
          ...
          className="flex items-center p-4 border border-gray-200 dark:border-neutral-700 rounded-lg hover:bg-gray-50 dark:hover:bg-neutral-800 transition-colors"
        >
          <DollarSign className="w-5 h-5 text-green-600 dark:text-green-400 mr-3" />
          <span className="text-sm font-medium text-gray-900 dark:text-white">View Earnings</span>
        </Link>
        ...
        <Link
          ...
          className="flex items-center p-4 border border-gray-200 dark:border-neutral-700 rounded-lg hover:bg-gray-50 dark:hover:bg-neutral-800 transition-colors"
        >
          <MessageSquare className="w-5 h-5 text-orange-600 dark:text-orange-400 mr-3" />
